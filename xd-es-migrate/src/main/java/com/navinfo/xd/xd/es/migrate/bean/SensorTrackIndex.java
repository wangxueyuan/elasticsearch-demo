...
@Document(indexName = "track", type = "sensor")
@Data
public class SensorTrackIndex implements Serializable {
	...
	public String vin;
	@Field(type = FieldType.Keyword)
	@Description(value = "数据源坐标系经纬度WKT表示法")
	public String geom;
	@Field(type = FieldType.Keyword)
	@Description(value = "数据源坐标系如gcj-02,wgs84等")
	public String coordinateSystem;
	@Field(type = FieldType.Double)
	@Description(value = "wgs84-经度，double(-180.0, +180.0)")
	public Double longitude;
	@Field(type = FieldType.Double)
	@Description(value = "wgs84-纬度，double(-90.0, +90.0)")
	...
	@Transient
	@Description(value = "轨迹上传状态")
	public Integer sendStatus;
	@Transient
    @Description(value = "ES高版本预留字段：CGCS2000轨迹点，由cgcs2000-经度（longitude）和cgcs2000-纬度（latitude）组成。ES Geometry类型")
    public GeoPoint geoPointCgcs2000;
	@Transient
    @Description(value = "ES高版本预留字段：CGCS2000 带号")
    public Integer cgcs2000Zone;
